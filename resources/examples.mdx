...
<CardGroup cols={2}>
  <Card title="Basic Setup" icon="rocket">
    Complete LEMP stack installation
  </Card>
  <Card title="WordPress Site" icon="wordpress">
    Deploy a WordPress site
  </Card>
  <Card title="Multi-Site Setup" icon="server">
    Host multiple websites
  </Card>
  <Card title="Reverse Proxy" icon="arrows-turn-right">
